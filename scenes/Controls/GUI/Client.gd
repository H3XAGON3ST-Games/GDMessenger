...
func data_verification(nickname: String, password: String, variation: String):
	send_data("%s%s%s%s%s" % [variation, Global.separator, nickname, Global.separator, password])
